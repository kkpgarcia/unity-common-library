...
namespace Common.Events
{
	public static class NotificationExtensions
	{
		...
		public static void PostCommand(this object obj, string notificationName, object e = null)
		{
			NotificationCenter.Instance.PostNotification(notificationName, notificationName, e);
		}
	}
}